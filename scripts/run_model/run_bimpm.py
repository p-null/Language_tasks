...
from paraphase.data.data_manager import DataManager
from paraphase.data.embedding_manager import EmbeddingManager
from paraphase.data.instances.sts_instance import QInstance
from paraphase.models.bimpm.bimpm import BiMPM
...
def main():
    ...
    if mode == "train":
        ...
        get_test_data_gen, test_data_size = data_manager.get_test_from_file(
            [config.test_file],
            mode="word+character")
